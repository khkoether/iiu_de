...
== Download
* {jruby-download-url}[JRuby 9.2.6.0] +
  `jruby-dist-9.2.6.0-bin.tar.gz`  (ca. 23M) +
  *2019-02-11 (Release date)*
...
----
$ tar xzvf jruby-dist-9.2.6.0-bin.tar.gz -C /opt/rubies/
...
----
...
$ ls -l /opt/rubies/   <1>
insgesamt 12
drwxr-sr-x 6 sid medien 4096 Feb 11 21:28 jruby-9.2.6.0
drwxr-xr-x 6 sid medien 4096 Dez 12 12:14 ruby-2.5.3

$ ln -s jruby /opt/rubies/jruby-9.2.6.0/bin/ruby   <2>
----
<1> Ziel-Verzeichnis.
...
----
$ ls -l /opt/rubies/jruby-9.2.6.0
drwxr-sr-x 2 sid medien   4096 Mär  2 09:36 bin       <1>
-rw-r--r-- 1 sid medien   1282 Feb 11 21:23 BSDL      <2>
-rw-r--r-- 1 sid medien 132268 Feb 11 21:23 COPYING
-rw-r--r-- 1 sid medien    218 Feb 11 21:23 LEGAL
drwxr-sr-x 4 sid medien   4096 Mär  2 09:33 lib
-rw-r--r-- 1 sid medien   2581 Feb 11 21:23 LICENSE.RUBY
drwxr-sr-x 6 sid medien   4096 Mär  2 09:33 samples
drwxr-sr-x 3 sid medien   4096 Mär  2 09:33 tool
----
<1> Datum der Installation.
<2> Release Date.

----
$ ls -l /opt/rubies/jruby-9.2.6.0/bin
-rwxr-xr-x 1 khk medien    5515 Feb 11 21:26 ast       <1>
-rw-r--r-- 1 khk medien      40 Feb 11 21:26 ast.bat   <2>
-rwxr-xr-x 1 khk medien     123 Feb 11 21:26 gem
-rw-r--r-- 1 khk medien      40 Feb 11 21:26 gem.bat
-rwxr-xr-x 1 khk medien     323 Feb 11 21:26 irb
-rw-r--r-- 1 khk medien      40 Feb 11 21:26 irb.bat
-rwxr-xr-x 1 khk medien     547 Feb 11 21:26 jgem
-rw-r--r-- 1 khk medien      41 Feb 11 21:26 jgem.bat
-rwxr-xr-x 1 khk medien     390 Feb 11 21:26 jirb
-rw-r--r-- 1 khk medien      41 Feb 11 21:26 jirb.bat
-rwxr-xr-x 1 khk medien    2263 Feb 11 21:26 jirb_swing
-rw-r--r-- 1 khk medien      47 Feb 11 21:26 jirb_swing.bat
-rwxr-xr-x 1 khk medien   13724 Feb 11 21:26 jruby
-rwxr-xr-x 1 khk medien     172 Feb 11 21:26 jruby200.sh
-rwxr-xr-x 1 khk medien   13724 Feb 11 21:26 jruby.bash
-rw-r--r-- 1 khk medien     125 Feb 11 21:26 jruby.bat
-rwxr-xr-x 1 khk medien     188 Feb 11 21:26 jrubyc
-rw-r--r-- 1 khk medien      43 Feb 11 21:26 jrubyc.bat
-rw-r--r-- 1 khk medien     245 Feb 11 21:26 jrubyd.bat
-rw-r--r-- 1 khk medien 1024512 Feb 11 21:26 jruby.dll
-rw-r--r-- 1 khk medien  959488 Feb 11 21:26 jruby.exe
-rwxr-xr-x 1 khk medien    9391 Feb 11 21:26 jruby.sh
-rw-r--r-- 1 khk medien  961536 Feb 11 21:26 jrubyw.exe
-rwxr-xr-x 1 khk medien     588 Feb 11 21:26 rake
-rw-r--r-- 1 khk medien      41 Feb 11 21:26 rake.bat
-rwxr-xr-x 1 khk medien     477 Feb 11 21:26 rdoc
-rw-r--r-- 1 khk medien      41 Feb 11 21:26 rdoc.bat
-rwxr-xr-x 1 khk medien     475 Feb 11 21:26 ri
-rw-r--r-- 1 khk medien      39 Feb 11 21:26 ri.bat
lrwxrwxrwx 1 khk medien       5 Mär  2 09:36 ruby -> jruby   <3>
-rwxr-xr-x 1 khk medien     152 Feb 11 21:26 testrb
-rw-r--r-- 1 khk medien      43 Feb 11 21:26 testrb.bat
----
...
----
<1> Die Version *JRuby 9.2.6.0* &nbsp;
    _entspricht dem Entwicklungsstand von_ &nbsp; *Ruby 2.5.3*.

----
$ which gem
/opt/rubies/jruby-9.2.6.0/bin/gem
...
----
$ which rake
/opt/rubies/jruby-9.2.6.0/bin/rake
...
----
$ which irb
/opt/rubies/jruby-9.2.6.0/bin/irb
...
Fetching: ffi-1.10.0-java.gem (100%)
Successfully installed ffi-1.10.0-java
...
Das Verzeichnis `~/.gem/jruby/2.5.3/...` -- entspricht der _Ruby_-Version -- nicht der _JRuby_-Version!

=== _list_
Mit *chruby* werden die zusätzlichen _RubyGems_ im
Home-Verzeichnis installiert: #~/.gem/jruby/#

.~/.gem/jruby/2.5.3/gems
----
ls -l ~/.gem/jruby/2.5.3/gems
drwxr-xr-x 8 sid sid 4096 Mär  2 10:16 asciidoctor-1.5.8
drwxr-xr-x 6 sid sid 4096 Mär  2 10:19 asciidoctor-revealjs-2.0.0
drwxr-xr-x 4 sid sid 4096 Mär  2 10:17 coderay-1.1.2
drwxr-xr-x 4 sid sid 4096 Mär  2 10:19 concurrent-ruby-1.1.4
drwxr-xr-x 2 sid sid 4096 Mär  2 10:22 ffi-1.10.0-java
drwxr-xr-x 4 sid sid 4096 Mär  2 10:22 method_source-0.9.2
drwxr-xr-x 5 sid sid 4096 Mär  2 10:24 mustermann-1.0.3
drwxr-xr-x 4 sid sid 4096 Mär  2 10:22 pry-0.12.2-java
drwxr-xr-x 7 sid sid 4096 Mär  2 10:24 rack-2.0.6
drwxr-xr-x 3 sid sid 4096 Mär  2 10:24 rack-protection-2.0.5
drwxr-xr-x 4 sid sid 4096 Mär  2 10:24 sinatra-2.0.5
drwxr-xr-x 4 sid sid 4096 Mär  2 10:22 spoon-0.0.6
drwxr-xr-x 8 sid sid 4096 Mär  2 10:19 thread_safe-0.3.6-java
drwxr-xr-x 7 sid sid 4096 Mär  2 10:24 tilt-2.0.9
----
...
./opt/rubies/jruby-9.2.6.0/bin
----
$ ls -l /opt/rubies/jruby-9.2.6.0/bin   <1>
-rwxr-xr-x 1 khk medien    5515 Feb 11 21:26 ast
-rw-r--r-- 1 khk medien      40 Feb 11 21:26 ast.bat
-rwxr-xr-x 1 khk medien     123 Feb 11 21:26 gem
-rw-r--r-- 1 khk medien      40 Feb 11 21:26 gem.bat
...
-rwxr-xr-x 1 khk medien     475 Feb 11 21:26 ri
-rw-r--r-- 1 khk medien      39 Feb 11 21:26 ri.bat
lrwxrwxrwx 1 khk medien       5 Mär  2 09:36 ruby -> jruby
-rwxr-xr-x 1 khk medien     152 Feb 11 21:26 testrb
-rw-r--r-- 1 khk medien      43 Feb 11 21:26 testrb.bat
----
...
.~/.gem/jruby/2.5.3/bin
----
$ ls -l ~/.gem/jruby/2.5.3/bin   <1>
-rwxr-xr-x 1 sid sid 630 Mär  2 10:16 asciidoctor
-rwxr-xr-x 1 sid sid 684 Mär  2 10:19 asciidoctor-revealjs
-rwxr-xr-x 1 sid sid 640 Mär  2 10:16 asciidoctor-safe
-rwxr-xr-x 1 sid sid 606 Mär  2 10:17 coderay
-rwxr-xr-x 1 sid sid 582 Mär  2 10:22 pry
-rwxr-xr-x 1 sid sid 592 Mär  2 10:24 rackup
-rwxr-xr-x 1 sid sid 588 Mär  2 10:24 tilt
----

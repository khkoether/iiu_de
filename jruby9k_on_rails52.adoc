...
*JRuby 9k* hat aktuell die Versions-Nummer *9.2.9.0*. +
...
$ which ruby
/opt/rubies/jruby-9.2.9.0/bin/ruby
...
rails (6.0.0)   <1>
----
<1> Seit dem 15.08.2019 ist das die neueste Version des RubyGem _rails_. +
    Ich installiere die - für *mich* relevante - Version *5.2.3* vom 28.03.2019! +
    Entsprechend der
...
$ gem install rails --version 5.2.3   <2>

$ gem install rails --version '~> 5.2.3'   <3>
----
<1> Die _aktuell_ neueste Version wird installiert -- zu diesem Moment: 6.0.0!
<2> Die _angegebene_ Version wird installiert -- also: 5.2.3.
<3> Twiddle Wakka: '~> 5.2.3' bedeutet, das die höchste Gem-Version von _rails_ +
    im Bereich von >= 5.2.3 und < 5.3 installiert wird -- zu diesem Moment: 5.2.3!
====
...
Fetching: nokogiri-1.10.5-java.gem (100%)
Successfully installed nokogiri-1.10.5-java
Fetching: crass-1.0.5.gem (100%)
Successfully installed crass-1.0.5
Fetching: loofah-2.3.1.gem (100%)
...
Fetching: nio4r-2.5.2-java.gem (100%)
...
Fetching: websocket-driver-0.7.1-java.gem (100%)
...
34 gems installed                    <1>
----
<1> Mit dem RubyGem _rails-5.2.3_ wurden insgesamt 34 Gems installiert. +
...
----
$ gem install activerecord-jdbc-adapter -v 52.4
Fetching: activerecord-jdbc-adapter-52.4-java.gem (100%)
Successfully installed activerecord-jdbc-adapter-52.4-java
1 gem installed
----

.MySQL
----
$ gem install activerecord-jdbcmysql-adapter -v 52.4
Fetching: jdbc-mysql-5.1.47.gem (100%)
Successfully installed jdbc-mysql-5.1.47
Fetching: activerecord-jdbcmysql-adapter-52.4-java.gem (100%)
Successfully installed activerecord-jdbcmysql-adapter-52.4-java
2 gems installed
----

.SQLite3
----
$ gem install activerecord-jdbcsqlite3-adapter -v 52.4
Fetching: jdbc-sqlite3-3.28.0.gem (100%)
Successfully installed jdbc-sqlite3-3.28.0
Fetching: activerecord-jdbcsqlite3-adapter-52.4-java.gem (100%)
Successfully installed activerecord-jdbcsqlite3-adapter-52.4-java
2 gems installed
----
...
activerecord-jdbc-adapter (52.4 java)
activerecord-jdbcmysql-adapter (52.4 java)
activerecord-jdbcsqlite3-adapter (52.4 java)
jdbc-mysql (5.1.47)
jdbc-sqlite3 (3.28.0)
----
...
$ cd RailsDir
$ rails _5.2.3_ new jMyApp --database=mysql -B  <1> <2> <3>
      create
      create  README.md
      create  Rakefile
      create  .ruby-version
...
----
<1> #+++_5.2.3_+++# -- Festlegen, welche Rails-Version verwendet werden soll. +
...
----
$ ls -l Gemfile*
-rw-r--r--  1 sid medien 1733 Nov  3 13:21 Gemfile
----
...
Fetching rake 13.0.0          <2>
Installing rake 13.0.0
Using concurrent-ruby 1.1.5   <3>
Using i18n 1.7.0
...
Using activerecord-jdbc-adapter 52.4 (java)
Using jdbc-mysql 5.1.47
Using activerecord-jdbcmysql-adapter 52.4 (java)
...
Fetching puma 3.12.1 (java)
Installing puma 3.12.1 (java)
...
Fetching: webdrivers-4.1.3.gem (100%)
Successfully installed webdrivers-4.1.3
1 gem installed
----
...
$ ls -l Gemfile*   <1>
-rw-r--r-- 1 sid medien 1754 Nov  3 13:58 Gemfile
-rw-r--r-- 1 sid medien 5274 Nov  3 13:58 Gemfile.lock
----
...
* Version 3.12.1 (jruby 9.2.9.0 - ruby 2.5.7), codename: Llamas in Pajamas   <1>
...
xpath (3.2.0)
----
<1> Anzahl der installierten RubyGems: _105_

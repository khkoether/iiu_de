...
von {jruby-url}[JRuby 1.7.24] unter GNU/Linux.
...
Download
--------
* {jruby-download-url}[JRuby 1.7.24] +    
  `jruby-bin-1.7.24.tar.gz`  (ca. 33M) +
  *2016-01-20 (Release date)* + 
JRuby 1.7.24 is our twenty-eigth update release since JRuby 1.7.0. 
...
----
$ ls -l 
-rw-rw-r-- 1 sid sid    21606407 Jan 24 11:56 jruby-bin-1.7.24.tar.gz
----
====
...
----
$ tar xvzf jruby-bin-1.7.24.tar.gz
...
----
...
----
$ mv jruby-1.7.24/ /opt/JRuby/sid
----

*Step 3*: Installation verifizieren
----
$ cd /opt/JRuby/sid/jruby-1.7.24
$ ls -l 
drwxr-xr-x 2 sid sid   4096 Jan 24 12:01 bin       <1>
-rw-r--r-- 1 sid sid 137174 Jan 20 16:50 COPYING   <2>
drwxrwxr-x 4 sid sid   4096 Jan 24 12:01 docs
drwxr-xr-x 4 sid sid   4096 Jan 24 12:01 lib
-rw-r--r-- 1 sid sid   2572 Jan 20 16:50 LICENSE.RUBY   <2>
drwxrwxr-x 6 sid sid   4096 Jan 24 12:01 samples
drwxrwxr-x 3 sid sid   4096 Jan 24 12:01 tool
----
...
----
$ ls -l bin
-rwxr-xr-x 1 sid sid   5670 Jan 20 16:55 ast       <1>
-rw-r--r-- 1 sid sid     40 Jan 20 16:55 ast.bat   <2>
-rwxr-xr-x 1 sid sid    123 Jan 20 16:55 gem
-rw-r--r-- 1 sid sid     40 Jan 20 16:55 gem.bat
-rwxr-xr-x 1 sid sid    323 Jan 20 16:55 irb
-rw-r--r-- 1 sid sid     40 Jan 20 16:55 irb.bat
-rwxr-xr-x 1 sid sid    547 Jan 20 16:55 jgem
-rw-r--r-- 1 sid sid     41 Jan 20 16:55 jgem.bat
-rwxr-xr-x 1 sid sid    390 Jan 20 16:55 jirb
-rw-r--r-- 1 sid sid     41 Jan 20 16:55 jirb.bat
-rwxr-xr-x 1 sid sid   1935 Jan 20 16:55 jirb_swing
-rw-r--r-- 1 sid sid     47 Jan 20 16:55 jirb_swing.bat
-rwxr-xr-x 1 sid sid  11474 Jan 20 16:55 jruby
-rwxr-xr-x 1 sid sid  11474 Jan 20 16:55 jruby.bash
-rw-r--r-- 1 sid sid    125 Jan 20 16:55 jruby.bat
-rwxr-xr-x 1 sid sid    188 Jan 20 16:55 jrubyc
-rw-r--r-- 1 sid sid     43 Jan 20 16:55 jrubyc.bat
-rw-r--r-- 1 sid sid    245 Jan 20 16:55 jrubyd.bat
-rw-r--r-- 1 sid sid 742400 Jan 20 16:55 jruby.dll
-rw-r--r-- 1 sid sid 680448 Jan 20 16:55 jruby.exe
-rwxr-xr-x 1 sid sid   8979 Jan 20 16:55 jruby.sh
-rw-r--r-- 1 sid sid 682496 Jan 20 16:55 jrubyw.exe
-rwxr-xr-x 1 sid sid    486 Jan 20 16:55 rake
-rw-r--r-- 1 sid sid     41 Jan 20 16:55 rake.bat
-rwxr-xr-x 1 sid sid    486 Jan 20 16:55 rdoc
-rw-r--r-- 1 sid sid     41 Jan 20 16:55 rdoc.bat
-rwxr-xr-x 1 sid sid    484 Jan 20 16:55 ri
-rw-r--r-- 1 sid sid     39 Jan 20 16:55 ri.bat
-rwxr-xr-x 1 sid sid    152 Jan 20 16:55 testrb
-rw-r--r-- 1 sid sid     43 Jan 20 16:55 testrb.bat
----
<1> Kommando #ast# für ein _GNU/Linux-System_
<2> Kommando #ast.bat# für ein _MS Windows-System_

*Step 4:* Der Pfad zum Verzeichnis `/opt/JRuby/sid/jruby-1.7.24` muß gesetzt werden.
----
$ cd /opt/JRuby/sid
$ ln -s jruby-1.7.24 current24

$ ls -lv
lrwxrwxrwx 1 sid sid    12 Jan 24 12:06 current -> jruby-1.7.24     <1>
lrwxrwxrwx 1 sid sid    12 Jan 24 12:05 current24 -> jruby-1.7.24   <1>
-rw-r--r-- 1 sid sid   131 Jan 24 12:10 jruby.path.sh
-rw-r--r-- 1 sid sid   133 Jan 24 12:11 jruby24.path.de   <2>
drwxr-xr-x 7 sid sid  4096 Jan 20 16:57 jruby-1.7.24
----
<1> Die symbolischen links 'current' und 'current24' zeigen auf die gleiche
    JRuby-Installation: +
    'jruby-1.7.24' -- meine 'default'-Installation.
<2> Erstellen Sie eine Datei `jruby24.path.sh` (siehe <<_anhang,[Anhang]>>). 
...
$ . jruby24.path.sh   <1>
---- 
<1> Oder mit dem Bash-Builtin Kommando: #source &nbsp; jruby24.path.sh#
=========================================================
...
$ jruby --version --1.8   <1>
jruby 1.7.24 (ruby-1.8.7p376) 2016-01-20 bd68d85 on OpenJDK 64-Bit Server VM 1.7.0_91-b02 +jit [linux-amd64]

$ jruby --version --2.0   <2>
jruby 1.7.24 (2.0.0p598) 2016-01-20 bd68d85 on OpenJDK 64-Bit Server VM 1.7.0_91-b02 +jit [linux-amd64]
----
...
auf die _JRuby 1.7.24_-Installation:

[options="nowrap"]
----
$ which gem
/opt/JRuby/sid/current24/bin/gem
...
wiederum dann zu einem offensichtlichem Kompilierfehler führt.
...
Fetching: jruby-openssl-0.9.14-java.gem (100%)
Successfully installed jruby-openssl-0.9.14-java
Updating json
...
----
$ ls -lrt /opt/JRuby/sid/jruby-1.7.24/bin
-rw-r--r-- 1 sid sid     43 Jan 20 16:55 testrb.bat
-rwxr-xr-x 1 sid sid    152 Jan 20 16:55 testrb
-rw-r--r-- 1 sid sid     39 Jan 20 16:55 ri.bat
-rw-r--r-- 1 sid sid     41 Jan 20 16:55 rdoc.bat
...
-rw-r--r-- 1 sid sid     40 Jan 20 16:55 gem.bat
-rwxr-xr-x 1 sid sid    123 Jan 20 16:55 gem
-rw-r--r-- 1 sid sid     40 Jan 20 16:55 ast.bat
-rwxr-xr-x 1 sid sid   5670 Jan 20 16:55 ast
-rwxr-xr-x 1 sid sid    527 Jan 24 12:19 lock_jars   <1>
-rwxr-xr-x 1 sid sid    486 Jan 24 12:19 rake
-rwxr-xr-x 1 sid sid    484 Jan 24 12:19 ri
-rwxr-xr-x 1 sid sid    486 Jan 24 12:19 rdoc
-rwxr-xr-x 1 sid sid    565 Jan 24 12:26 rdoc-data
-rwxr-xr-x 1 sid sid    514 Jan 24 12:30 asciidoctor
-rwxr-xr-x 1 sid sid    519 Jan 24 12:30 asciidoctor-safe
-rwxr-xr-x 1 sid sid    498 Jan 24 12:30 coderay
-rwxr-xr-x 1 sid sid    482 Jan 24 12:32 pry
-rwxr-xr-x 1 sid sid    488 Jan 24 12:32 rackup
-rwxr-xr-x 1 sid sid    486 Jan 24 12:32 tilt     <1>
----
...
----
JRUBY_HOME=/opt/JRuby/sid/current24   <1>
#JRUBY_OPTS=--1.8   <2>
...
JRUBY_HOME=/opt/JRuby/sid/current24
#JRUBY_OPTS=--1.8   <2>

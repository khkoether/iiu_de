...
*JRuby 9k* hat aktuell die Versions-Nummer *9.2.5.0*. +
Sie _entspricht_ dem Entwicklungsstand von &nbsp; *Ruby 2.5.0*.
====
...
$ which ruby
/opt/rubies/jruby-9.2.5.0/bin/ruby
...
-> http://guides.rubyonrails.org/v5.2/[Ruby on Rails Guides (v5.2.2)]
...
Fetching: nokogiri-1.8.5-java.gem (100%)
Successfully installed nokogiri-1.8.5-java
...
35 gems installed                    <1>
----
<1> Mit dem RubyGem _rails-5.2.2_ wurden insgesamt 35 Gems installiert. +
...
----
$ ls -l Gemfile*
-rw-r--r-- 1 khk medien 1294 Dez 16 15:46 Gemfile
----
...
$ ls -l Gemfile*   <1>
-rw-r--r-- 1 khk medien 1294 Dez 16 15:46 Gemfile
-rw-r--r-- 1 khk medien 4340 Dez 16 15:58 Gemfile.lock
----
<1> Als Benutzer 'sid'!
...
$ ls -l Gemfile*   <1>
-rw-r--r-- 1 khk medien 1330 Dez 16 16:09 Gemfile
-rw-r--r-- 1 khk medien 4504 Dez 16 16:09 Gemfile.lock
----
<1> Als Benutzer 'sid'!
...
=> Run `rails server -h` for more startup options
WARNING: An illegal reflective access operation has occurred
WARNING: Illegal reflective access by org.jruby.java.invokers.FieldMethodZero to field java.io.ByteArrayOutputStream.buf
WARNING: Please consider reporting this to the maintainers of org.jruby.java.invokers.FieldMethodZero
WARNING: Use --illegal-access=warn to enable warnings of further illegal reflective access operations
WARNING: All illegal access operations will be denied in a future release
Puma starting in single mode...
* Version 3.12.0 (jruby 9.2.5.0 - ruby 2.5.0), codename: Llamas in Pajamas   <1>

...
* {git-download-url}[Git] +
  `git-2.23.0.tar.gz`  &nbsp; -- &nbsp; ca. 8,3M +
  `git-htmldocs-2.23.0.tar.gz` &nbsp; -- &nbsp; ca. 3,0M +
  `git-manpages-2.23.0.tar.gz` &nbsp; -- &nbsp; ca. 721K +
  2018-12-09 (Release date) --
  https://raw.githubusercontent.com/git/git/master/Documentation/RelNotes/2.23.0.txt[Git 2.20 Release Notes]
...
----
$ ls -lh
-rw-rw-r--  1 khk  khk    8,3M Okt 27 18:06 git-2.23.0.tar.gz
-rw-rw-r--  1 khk  khk    3,0M Okt 27 18:06 git-htmldocs-2.23.0.tar.gz
-rw-rw-r--  1 khk  khk    721K Okt 27 18:06 git-manpages-2.23.0.tar.gz
----
====
...
-rwxr-xr-x 129 root root 16962992 Okt 27 18:19 git
-rwxr-xr-x   2 root root   162737 Okt 27 18:19 git-cvsserver
-rwxr-xr-x   1 root root   351673 Okt 27 18:19 gitk
-rwxr-xr-x 129 root root 16962992 Okt 27 18:19 git-receive-pack
-rwxr-xr-x   2 root root 10141872 Okt 27 18:19 git-shell
-rwxr-xr-x 129 root root 16962992 Okt 27 18:19 git-upload-archive
-rwxr-xr-x 129 root root 16962992 Okt 27 18:19 git-upload-pack
----
...
$ cd git-doc
$ sudo tar xvzf git-htmldocs-2.23.0.tar.gz
...
...
drwxr-sr-x 5 root root 20480 Aug 16 22:04 git-doc        <2>
----
<1> Unbedingt die Rechte an den Dateien und den Ordnern anpassen!
<2> Release Date: 2019-08-16

.Documentation: man-pages
----
$ cd /usr/local/share/man
$ sudo tar xvzf git-manpages-2.23.0.tar.gz
...
...
$ ls -l man
drwxr-sr-x 2 root root 4096 Aug 16 22:05 man1   <2>
drwxr-sr-x 2 root root 4096 Aug 16 22:05 man5   <2>
drwxr-sr-x 2 root root 4096 Aug 16 22:05 man7   <2>
----
<1> Unbedingt die Rechte an den Dateien und den Ordnern anpassen!
<2> Release Date: 2019-08-16
...
== Anhang
Script zum Installieren von {git-url}[Git] 2.23.0 (ohne weitere Erläuterung). +

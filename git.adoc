...
Version 5.2.4 {middot} November 2019
...
* {git-download-url}[Git] +
  `git-2.24.0.tar.gz`  &nbsp; -- &nbsp; ca. 8,4M +
  `git-htmldocs-2.24.0.tar.gz` &nbsp; -- &nbsp; ca. 3,0M +
  `git-manpages-2.24.0.tar.gz` &nbsp; -- &nbsp; ca. 729K +
  2019-11-04 (Release date) --
  https://raw.githubusercontent.com/git/git/master/Documentation/RelNotes/2.24.0.txt[Git 2.24 Release Notes]
...
----
$ ls -lh
-rw-rw-r-- 1 sid sid 8,4M Nov  9 10:59 git-2.24.0.tar.gz
-rw-rw-r-- 1 sid sid 3,0M Nov  9 11:00 git-htmldocs-2.24.0.tar.gz
-rw-rw-r-- 1 sid sid 729K Nov  9 11:00 git-manpages-2.24.0.tar.gz
----
====
...
-rwxr-xr-x 129 root root 17093928 Nov  9 15:34 git
-rwxr-xr-x   2 root root   162737 Nov  9 15:34 git-cvsserver
-rwxr-xr-x   1 root root   353477 Nov  9 15:34 gitk
-rwxr-xr-x 129 root root 17093928 Nov  9 15:34 git-receive-pack
-rwxr-xr-x   2 root root 10246384 Nov  9 15:34 git-shell
-rwxr-xr-x 129 root root 17093928 Nov  9 15:34 git-upload-archive
-rwxr-xr-x 129 root root 17093928 Nov  9 15:34 git-upload-pack
----
...
$ cd git-doc
$ sudo tar xvzf git-htmldocs-2.24.0.tar.gz
...
...
drwxr-sr-x 5 root root 20480 Nov  4 06:08 git-doc        <2>
----
<1> Unbedingt die Rechte an den Dateien und den Ordnern anpassen!
<2> Release Date: 2019-11-04

.Documentation: man-pages
----
$ cd /usr/local/share/man
$ sudo tar xvzf git-manpages-2.24.0.tar.gz
...
...
$ ls -l man
drwxr-sr-x 2 root root 4096 Nov  4 22:05 man1   <2>
drwxr-sr-x 2 root root 4096 Nov  4 22:05 man5   <2>
drwxr-sr-x 2 root root 4096 Nov  4 22:05 man7   <2>
----
<1> Unbedingt die Rechte an den Dateien und den Ordnern anpassen!
<2> Release Date: 2019-11-04
...
== Anhang
Script zum Installieren von {git-url}[Git] 2.24.0 (ohne weitere Erläuterung). +

...
Ubuntu 16.04 LTS (Xenial Xerus) enthält das Paket::
  _git-core_2.7.4-0ubuntu1_all.deb_.
====


== Download
* {git-download-url}[Git] +
  `git-2.12.2.tar.gz`  (ca. 6.1M) +
  `git-htmldocs-2.12.2.tar.gz`  (ca. 2.6M) +
  `git-manpages-2.12.2.tar.gz`  (ca. 639K) +
  2017-03-24 (Release date)
...
----
$ ls -lh
-rw-rw-r-- 1 sid sid 6,1M Apr  9 20:58 git-2.12.2.tar.gz
-rw-rw-r-- 1 sid sid 2,6M Apr  9 20:59 git-htmldocs-2.12.2.tar.gz
-rw-rw-r-- 1 sid sid 639K Apr  9 20:59 git-manpages-2.12.2.tar.gz
----
====
...
$ cd git-doc
$ sudo tar xvzf git-htmldocs-2.12.2.tar.gz
...
...
drwxr-xr-x 5 root root 20480 Mär 24 21:51 git-doc        <2>
----
<1> Unbedingt die Rechte an den Dateien und den Ordnern anpassen!
<2> Release Date: 2017-03-24

.Documentation: man-pages
----
$ cd /usr/local/share/man
$ sudo tar xvzf git-manpages-2.12.2.tar.gz
...
...
$ ls -l man
drwxr-xr-x 2 root root 4096 Mär 24 21:52 man1   <2>
drwxrwxr-x 2 root root 4096 Apr  9 21:23 man3
drwxr-xr-x 2 root root 4096 Mär 24 21:52 man5   <2>
drwxr-xr-x 2 root root 4096 Mär 24 21:52 man7   <2>
----
<1> Unbedingt die Rechte an den Dateien und den Ordnern anpassen!
<2> Release Date: 2017-03-24
...
$ cd /usr/local/bin
$ ls -l git*
-rwxr-xr-x 118 root root 10871352 Apr  9 21:23 git
-rwxr-xr-x   2 root root   162414 Apr  9 21:23 git-cvsserver
-rwxr-xr-x   1 root root   351673 Apr  9 21:23 gitk
-rwxr-xr-x 118 root root 10871352 Apr  9 21:23 git-receive-pack
-rwxr-xr-x   2 root root  5656112 Apr  9 21:23 git-shell
-rwxr-xr-x 118 root root 10871352 Apr  9 21:23 git-upload-archive
-rwxr-xr-x   2 root root  6087320 Apr  9 21:23 git-upload-pack
----
...
== Anhang
Script zum Installieren von {git-url}[Git] 2.12.2 (ohne weitere Erläuterung). +
